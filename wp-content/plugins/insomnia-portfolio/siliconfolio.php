...
function st_sf__load_custom_wp_admin_style() {
  wp_register_style( 'st_sf_custom_wp_admin_css',  plugin_dir_url( __FILE__ ) . '/framework/css/admin.css', false, '1.0.0' );
  wp_enqueue_style( 'st_sf_custom_wp_admin_css' );
}
...
/* Extra Fields.  */
/* ------------------------------------------------------------------------ */
add_action('admin_init', 'extra_fields_plugins');
