...
Class null_instagram_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( '' !== $username ) {
			...
			if ( is_wp_error( $media_array ) ) {
				...
				$template_part = apply_filters( 'wpiw_template_part', 'parts/insomnia.php' );

				?><ul class="<?php echo esc_attr( $ulclass ); ?>"><?php
				foreach( $media_array as $item ) {
					// copy the else line into a new file (parts/insomnia.php) within your theme and customise accordingly.
	...
	function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, array(
			'title' => __( 'Instagram', 'insomnia' ),
			'username' => '',
			'size' => 'large',
			'link' => __( 'Follow Me!', 'insomnia' ),
			'number' => 9,
			'target' => '_self',
		) );
		...
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( '@username or #tag', 'insomnia' ); ?>: <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'username' ) ); ?>" type="text" value="<?php echo esc_attr( $username ); ?>" /></label></p>
